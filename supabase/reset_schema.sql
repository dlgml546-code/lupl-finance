...
-- 기존 테스트 데이터가 삭제됩니다.
-- Supabase Storage 내부 테이블은 직접 삭제하지 않습니다.
-- ============================================================
